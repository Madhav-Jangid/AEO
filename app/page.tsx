    ...
    <section className="px-4 md:mt-20  md:px-5 pt-[30px] pb-[60px] flex justify-center">
      ...
      >
        ...
        <Image
          ...
          className="block lg:hidden w-full -mx-6 md:-mx-8 mt-8 max-h-[400px] object-cover"
          width={1200}
          height={400}
          unoptimized
        />
        ...
        <Image
          src="https://framerusercontent.com/images/cLhE0zz9KoEfqjG2JcfNsvEDpA0.png"
          alt="AEOlytics diagnostic report preview"
          className="hidden lg:block absolute right-[-100px] bottom-[-250px] z-[1] object-cover"
          width={640}
          height={723}
          unoptimized
        />
        ...
        {features.map((f, i) => (
          ...
          >
            ...
            <div className="w-full max-w-[380px] lg:w-[380px]" style={{ height: "auto", aspectRatio: "0.806" }}>
              <Image src={f.image} alt={f.imageAlt} width={380} height={471} className="w-full h-full rounded-[20px] object-cover" unoptimized />
            </div>
          </div>
        ))}
      </div>
    ...
    <section className="flex justify-center px-4 md:px-5" style={{ padding: "100px 0" }}>
      ...
      >
        ...
        <Image
          ...
          className="hidden lg:block absolute top-[-20px] right-[-107px] z-[1] object-cover"
          width={552}
          height={628}
          unoptimized
        />
